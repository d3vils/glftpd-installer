...
TIMEEMPTY="10"          # Minutes before nuke.
...
TIMEHALFEMPTY="360"     # Minumum age to nuke.
HALFEMPTYMULTIPLIER="3" # Nuke multiplier
EMBARRESHALF="TRUE"     # Send detailed nuke report.
EMPTYEXCLUDE=".fix.nfo .mpg .m2v .mpeg .zip .rar .r00 .r01 .mp3 .000 .001" # See README
...
TIMEINCOM="360"       	# Minumum age in minutes to nuke. 
