...
- Enabled the copy of cleanup script much earlier in the script in case someone decides to abort in the middle of things 
and want to remove things from system
